...
function getPayloadConfigFromPayload(
  ...
  let payloadPayload: Record<string, any> | undefined;
  if ("payload" in payload) {
    const potentialNestedPayload = (payload as { payload: unknown }).payload;
    if (typeof potentialNestedPayload === "object" && potentialNestedPayload !== null) {
      payloadPayload = potentialNestedPayload as Record<string, any>;
    }
  }
